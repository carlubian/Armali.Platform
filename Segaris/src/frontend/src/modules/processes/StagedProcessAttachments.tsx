...
export interface StagedProcessAttachmentsProps {
  files: File[]
  onChange: (files: File[]) => void
}

export function StagedProcessAttachments({
  files,
  onChange,
}: StagedProcessAttachmentsProps) {
  ...
  return (
    <div className="seg-proc-attach">
      ...
      {files.length === 0 ? (
        ...
        <>
          <p className="seg-proc-editor__hint">{t('editor.attachments.stagedHint')}</p>
              ...
              return (
                <li
                  ...
                  className={
                    ...
                    (rejection != null ? ' seg-proc-attach__item--error' : '')
                  }
                >
                  <FileText
                    size={18}
                  ...
                  <span className="seg-proc-attach__meta">
                    <span className="seg-proc-attach__name">{file.name}</span>
