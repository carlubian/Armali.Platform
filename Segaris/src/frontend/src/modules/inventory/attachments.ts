/**
 * Client-side attachment helpers for Inventory. They mirror the Capex and Opex
 * helpers so the item and order editors give the same immediate feedback the
 * server enforces (allowed extensions and the 25 MB ceiling) before a request is
 * ever sent.
 */
