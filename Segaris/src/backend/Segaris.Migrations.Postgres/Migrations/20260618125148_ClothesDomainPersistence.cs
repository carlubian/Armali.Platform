    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                NormalizedName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                ColorValue = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: false),
                SortOrder = table.Column<int>(type: "integer", nullable: false),
                CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                CreatedBy = table.Column<int>(type: "integer", nullable: true),
                UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                WashingCare = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                DryingCare = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                IroningCare = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                DryCleaningCare = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
