        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedValue = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tags", x => x.Id);
                    table.CheckConstraint("CK_tags_type", "\"Type\" IN ('Person', 'Place', 'Topic')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_image_tags_TagId_ImageId",
                table: "image_tags",
                columns: new[] { "TagId", "ImageId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_images_OwnerUserId_ReviewedAt",
                table: "images",
                columns: new[] { "OwnerUserId", "ReviewedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_images_OwnerUserId_Sha256",
                table: "images",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tags_OwnerUserId_Type_NormalizedValue",
                table: "tags",
                columns: new[] { "OwnerUserId", "Type", "NormalizedValue" },
                unique: true);
        }
