...
export interface DialogProps extends Omit<ComponentPropsWithRef<'div'>, 'title'> {
  ...
  width?: number | string
  /**
   * Accessible label for the close button. Required: the interface is Spanish
   ...
   * title and footer pinned. Used by large editors; short confirmation dialogs
   * leave it off.
   */
  scrollable?: boolean
}
 ...
 * the topmost one reacts to Escape and traps focus. Unlike the prototype,
 * `closeLabel` is mandatory so the dismiss control always carries a translated
 * accessible name.
 */
