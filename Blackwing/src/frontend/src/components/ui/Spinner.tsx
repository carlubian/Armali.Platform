...
export interface SpinnerProps extends Omit<ComponentPropsWithRef<'span'>, 'children'> {
  ...
  /**
   * Accessible status label announced to assistive technology. Required: the
   * interface is Spanish and every user-facing text, visible or announced, comes
   * from i18next.
   */
  label: string
}
 ...
 * Unlike the prototype, `label` is mandatory so the announced status text always
 * comes from the translation resources.
 */
