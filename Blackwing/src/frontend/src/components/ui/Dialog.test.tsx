...
describe('Dialog', () => {
  it('renders nothing when closed', () => {
    render(
      <Dialog closeLabel="Close" open={false} title="Hidden">
        Body
      </Dialog>,
    )
  ...
  it('moves focus to the dialog panel on open', () => {
    render(
      <Dialog closeLabel="Close" title="Focus me">
        Body
      </Dialog>,
    )
  ...
  it('closes via the close button, the Escape key, and the backdrop', async () => {
    ...
    const onClose = vi.fn()
    render(
      <Dialog closeLabel="Close" title="Closable" onClose={onClose}>
        Body
      </Dialog>,
    )
  ...
  it('keeps Tab focus inside the topmost dialog when dialogs are stacked', async () => {
    ...
    render(
      <>
        <Dialog closeLabel="Close" title="Editor" onClose={() => {}}>
  ...
  it('only closes the topmost dialog on Escape when dialogs are stacked', async () => {
    ...
    render(
      <>
        <Dialog closeLabel="Close" title="Editor" onClose={onCloseEditor}>
          Editor body
        </Dialog>
        <Dialog closeLabel="Close" title="Selector" onClose={onCloseSelector}>
          Selector body
        </Dialog>
      </>,
    )
